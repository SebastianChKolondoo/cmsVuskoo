        ...
        <div class="col-12 col-md-6">
            <div class="card">
                <div class="card-header">
                    <h2>Editar oferta fibra, movil y TV</h2>
                </div>
                <div class="card-body">
                    @if (session('info'))
                    ...
                    @endif
                    {!! Form::model($tarifa, ['route' => ['parrillafibramoviltv.update', $tarifa], 'method' => 'put']) !!}
                    ...
                    <div class="form-group">
                        ...
                        @foreach ($states as $state)
                            <div>
                                <label>
                                    {!! Form::radio('TV', $state->id, 1, ['class' => 'my-1 d-flex', 'required' => 'required']) !!}
                                    {{ $state->name }}
                                </label>
                            </div>
                        @endforeach
                    ...
                    <div class="form-group">
                        ...
                        @foreach ($states as $state)
                            <div>
                                <label>
                                    {!! Form::radio('Netflix', $state->id, 1, ['class' => 'my-1 d-flex']) !!}
                                    {{ $state->name }}
                                </label>
                            </div>
                        @endforeach
                    ...
                    <div class="form-group">
                        ...
                        @foreach ($states as $state)
                            <div>
                                <label>
                                    {!! Form::radio('HBO', $state->id, 1, ['class' => 'my-1 d-flex']) !!}
                                    {{ $state->name }}
                                </label>
                            </div>
                        @endforeach
                    ...
                    <div class="form-group">
                        ...
                        @foreach ($states as $state)
                            <div>
                                <label>
                                    {!! Form::radio('AmazonPrime', $state->id, 1, ['class' => 'my-1 d-flex']) !!}
                                    {{ $state->name }}
                                </label>
                            </div>
                        @endforeach
                    ...
                    <div class="form-group">
                        ...
                        @foreach ($states as $state)
                            <div>
                                <label>
                                    {!! Form::radio('Filmin', $state->id, 1, ['class' => 'my-1 d-flex']) !!}
                                    {{ $state->name }}
                                </label>
                            </div>
                        @endforeach
                    ...
                    <div class="form-group">
                        ...
                        @foreach ($states as $state)
                            <div>
                                <label>
                                    {!! Form::radio('DAZN', $state->id, 1, ['class' => 'my-1 d-flex']) !!}
                                    {{ $state->name }}
                                </label>
                            </div>
                        @endforeach
                    ...
                    <div class="form-group">
                        ...
                        @foreach ($states as $state)
                            <div>
                                <label>
                                    {!! Form::radio('otros_canales_TV', $state->id, 1, ['class' => 'my-1 d-flex']) !!}
                                    {{ $state->name }}
                                </label>
                            </div>
                        @endforeach
