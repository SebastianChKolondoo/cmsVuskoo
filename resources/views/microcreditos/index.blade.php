...
@section('content')
    <div class="row justify-content-center my-4">
        <div class="col-12">
            ...
            @endif
            @can('microcreditos.view.btn-create')
                <a href="{{ route('microcreditos.create') }}" class="btn btn-primary">Nueva tarifa</a>
            @endcan
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <h4>Listado de Microcreditos</h4>
        </div>
    </div>
                ...
                <tbody>
                    @foreach ($tarifas as $data)
                        <tr>
                            ...
                            <td>
                                @can('microcreditos.view.btn-edit')
                                    <a href="{{ route('microcreditos.edit', $data) }}" class="btn btn-primary">Editar</a>
                                @endcan
                                {{-- @can('microcreditos.view.btn-duplicate')
